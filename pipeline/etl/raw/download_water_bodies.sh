...
# clip
#ogr2ogr -clipsrc ${DATADIR}/water_bodies/shps/hydropolys.shp ${DATADIR}/water_bodies/shps/${CITY}.shp $COUNTY_SHP

# upload to postgresql
#shp2pgsql -s 4326 -d -D -I -W "latin1" ${DATADIR}/water_bodies/shps/hydropolys.shp raw.${CITY}_water_bodies | psql -d $PGDATABASE -h $PGHOST -U $POSTGRES_USER
